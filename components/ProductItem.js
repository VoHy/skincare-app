            ...
            <View style={styles.infoContainer}>
                ...
                <View style={styles.priceContainer}>
                    {item.discount?.value > 0 ? (
                        <>
                            ...
                            <Text style={styles.finalPrice}>{item.discount_price?.toLocaleString()}đ</Text>
                        </>
                    ) : (
                ...
                {item.discount?.value > 0 && daysRemaining > 0 && (
                    <Text style={styles.countdownText}>
                        🔥 Còn {daysRemaining} ngày - Tiết kiệm {((item.price - item.discount_price) / item.price * 100).toFixed(0)}%
                    </Text>
                )}
            </View>
